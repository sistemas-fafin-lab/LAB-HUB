...
interface TopbarProps {
  patient: Dependent
  onPickPatient: (d: Dependent) => void
  dark: boolean
  onToggleDark: () => void
  route: AppRoute
...
export function Topbar({ patient, onPickPatient, dark, onToggleDark }: TopbarProps) {
      ...
      <div className="px-6 h-16 flex items-center gap-4">
        ...
        <div className="flex items-center gap-2 ml-auto">
          ...
          <div className="relative">
            ...
            >
              <div
                className={`h-8 w-8 rounded-lg bg-gradient-to-br ${patient.color} text-white text-xs font-bold flex items-center justify-center`}
              >
                {patient.initials}
              </div>
              ...
              <>
                ...
                >
                  ...
                  {DEPENDENTS.map((d) => (
                    <button
                      key={d.id}
                      onClick={() => { onPickPatient(d); setOpen(false) }}
